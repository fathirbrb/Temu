...
*TEMU (Tetap Dekat Meski Berjauhan)*`;
  ...
  return (
    <div>
      ...
      {/* KPI Cards Grid - Compact Inline Layout */}
      <div className="stats-grid compact">
        ...
        {/* Normal Status */}
        <div className="stat-card compact normal">
          <div className="stat-icon-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Waspada Status */}
        <div className="stat-card compact waspada">
          <div className="stat-icon-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="stat-details">
            ...
            <span className="stat-label">Waspada</span>
          </div>
        </div>

        {/* Bahaya Status */}
        <div className="stat-card compact bahaya">
          <div className="stat-icon-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="stat-details">
            ...
            <span className="stat-label">Bahaya</span>
          </div>
        </div>
      </div>
